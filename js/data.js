export const questions = [
  {
    number: '01',
    question: ' 불의 섬에 입성했다. 가장 먼저 생활공간이자 방어해야 하는 기지를 선택해야 한다.',
    choices: [
      { text: '다른 팀에 노출될 가능성도 높지만 우리가 침투하기에도 유리한 섬 중앙 기지', value: 'c' },
      { text: '우리가 침입하러 가기에는 멀지만 다른 팀이 오기에도 험해 방어에 유리한 바닷가 절벽 기지', value: 'f' }
    ]
  },
  {
    number: '02',
  ...
  },
  {
    ...
    choices: [
      { text: '모든 인원이 뛰어나가 전력으로 상대 기지를 함락해 빠르게 상황을 끝낸다', value: 'a' },
      { text: '혹시 모를 상황을 대비해 인원을 나눠 대응한다', value: 'd' }
    ]
  },
  {
    number: '06',
    question: '다른 팀과 연합을 맺었다. <br/> 함께 또 다른 팀을 공격하러 갈 때 나는?',
    choices: [
      { text: '등 뒤를 믿고 전력으로 공격한다', value: 'u' },
      { text: '영원한 동지는 없다 - 함께 공격하지만 연합한 팀에 대한 경계도 늦추지 않는다', value: 's' }
    ]
  },
  {
    number: '07',
    question: '한정된 자원을 보급 받을 수 있다. 우리 팀의 선택은?',
    choices: [
      { text: '식량', value: 'm' },
      { text: '무기', value: 'w' }
    ]
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '이 상황에서 방어를 돕는 건 의미 없다. 상대팀의 기지를 빨리 함락시키는 게 돕는 거다', value: '' }
    ]
  },
  {
    number: '10',
    ...
    choices: [
      { text: '내가 첫 번째 선수로 출전해 최대한 적게 남긴다', value: '' },
